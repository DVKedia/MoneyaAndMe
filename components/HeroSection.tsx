  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-16 md:pt-0">
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        {/* Trust Indicators */}
        <div className="flex flex-wrap justify-center items-center gap-8 text-sm fade-in-up" style={{animationDelay: '0.6s'}}>
          <div className="flex items-center bg-white/95 backdrop-blur-md px-4 py-2 rounded-full shadow-lg border border-white/20">
            <svg className="w-4 h-4 mr-2 text-emerald-500" fill="currentColor" viewBox="0 0 20 20">
              <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
            </svg>
            <span className="text-neutral-800 font-semibold">5000+ Lives Transformed</span>
          </div>
          <div className="flex items-center bg-white/95 backdrop-blur-md px-4 py-2 rounded-full shadow-lg border border-white/20">
            ...
            <span className="text-neutral-800 font-semibold">98% Success Rate</span>
          </div>
          <div className="flex items-center bg-white/95 backdrop-blur-md px-4 py-2 rounded-full shadow-lg border border-white/20">
            <svg className="w-4 h-4 mr-2 text-teal-500" fill="currentColor" viewBox="0 0 20 20">
              <path fillRule="evenodd" d="M3.172 5.172a4 4 0 015.656 0L10 6.343l1.172-1.171a4 4 0 115.656 5.656L10 17.657l-6.828-6.829a4 4 0 010-5.656z" clipRule="evenodd" />
            </svg>
            <span className="text-neutral-800 font-semibold">25+ Years Experience</span>
          </div>
        </div>
      </div>
    </section>
